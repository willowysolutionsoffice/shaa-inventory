  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
"relative w-(--sidebar-width) bg-transparent transition-all duration-300 ease-in-out",          "group-data-[collapsible=offcanvas]:w-0",
      ...
      <div
        ...
        className={cn(
"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-all duration-300 ease-in-out md:flex",          side === "left"
